...
// ========================================
// STUDENT OR STAFF SELECTION PAGE
// ========================================

/*
 * This component has no props or local state.
 * TypeScript can infer the component return type,
 * so no extra interface is required here.
 */
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-12 col-sm-10 col-md-9 col-lg-7 col-xl-6">
            <div className="studentLogin p-3 p-sm-4 p-md-5">
              ...
              <div
                className="text-center message mt-4 mb-3"
                style={{
                  fontSize: "18px",
                }}
              >
